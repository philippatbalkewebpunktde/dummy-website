## Überblick
Das Projekt ist eine Webanwendung, die die Startseite durch ein gelegentlich animiertes Einhorn-Gif unterhaltsamer gestaltet. Die Animation erfolgt zufällig und ist konfigurierbar. Zusätzlich bietet die Anwendung eine dynamische Begrüßung basierend auf der aktuellen Tageszeit und zeigt die aktuelle Uhrzeit in UTC an.
...
- Die Anwendung zeigt eine dynamische Begrüßung basierend auf der aktuellen Tageszeit an.
- Die aktuelle Uhrzeit in UTC wird angezeigt, sofern der Zeitserver erreichbar ist. Bei Fehlern wird eine entsprechende Fehlermeldung angezeigt.

## Landkarte — wo finde ich was
- **Anforderungen**: `requirements.md`
- **Architektur**: `architecture.md`
- **Konfiguration**: `config.json` (URL der Einhorn-Grafik)
- **HTML-Struktur**: `index.html`, `about.html`, `contact.html`
- **JavaScript-Logik**: `script.js`, `scripts/timeGreeting.js`, `time.js`
